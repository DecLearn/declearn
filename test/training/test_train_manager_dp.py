...
class TestDPTrainingManager:
    ...
    def test_precompute_matches_canonical_with_prior_history(
        self, accountant, prev
    ):
        """Precompute matches a per-step `get_epsilon` check per accountant.
        ...
        # from scratch each time so the probe shares no state or history-
        # surgery with the code under test.
